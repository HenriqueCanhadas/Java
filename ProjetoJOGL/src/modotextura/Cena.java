...
public class Cena implements GLEventListener, KeyListener {
    ...
    public static final String FACE1 = "imagens/madeira.jpg";
        ...
        *
        ...
        if(triangulo){
            ...
            gl.glBegin(GL2.GL_TRIANGLES);
                ...
                gl.glTexCoord2f(0.5f, 1.0f); gl.glVertex2f(0.0f, 50.0f);
                gl.glTexCoord2f(1.0f, 0.0f); gl.glVertex2f(50.0f, -50.0f);
            gl.glEnd();
        }else{
